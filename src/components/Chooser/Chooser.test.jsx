...
const chooserOptions = [
  { id: 'a', textHeader: 'Option A', textBody: 'This is option A', icon: icon1, helper: 'helper-a' },
  { id: 'b', textHeader: 'Option B', textBody: 'This is option B', icon: icon2, helper: 'helper-b' }
]
...
test('Chooser render with icons', async () => {
  ...
  const firstIconElement = within(firstItem).getByTestId('LightbulbOutlinedIcon')
