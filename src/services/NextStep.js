export const keyByValue = (steps, value) => {
  const [key] = Object.entries(steps).find(([, val]) => val === value) || []
  return key || null
}
...
export const NextStep = {
  NEW_LINK_MEMBER_CONTRACT_FORM_SUBSTEPS: {
    ...
    SUPPLY_INFO: () => "POWER",
    POWER: (values) =>
      values.has_member === "member-on" && values.has_light === "light-off"
        ? "DONATION"
    ...
    SELFCONSUMPTION: (values) =>
      ...
      values.has_selfconsumption === "selfconsumption-on"
        ? "SELFCONSUMPTION_INFO"
        : "HOLDER_INFO",
    SELFCONSUMPTION_INFO: () => "HOLDER_INFO",
    HOLDER_INFO: (values) =>
      values.has_member === "member-on" && values.has_light === "light-on"
        ? "DONATION"
        : "MEMBER_INFO",
  ...
  NEW_MEMBER_CONTRACT_FORM_SUBSTEPS: {
    ...
    SUPPLY_INFO: () => "POWER",
    POWER: (values) =>
      values.has_light === "light-off" ? "DONATION" : "SELFCONSUMPTION",
    SELFCONSUMPTION: (values) =>
      values.has_light === "light-on" &&
      values.has_selfconsumption === "selfconsumption-on"
        ? "SELFCONSUMPTION_INFO"
