          ...
          power2: Yup.number()
            ...
            .test("increasing", "NO_POWER_INCREASING", function () {
              return rates["power-lower-15kw"]?.increasing
                ? parseFloat(this.parent.power2) >=
                    parseFloat(this.parent.power1)
                : true
            })
            .test({
              name: "minPowerValue",
