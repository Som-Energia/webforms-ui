    ...
    <>
      ...
      <div className={classes.container}>
        ...
        <Typography className={classes.message} variant="body1"
          dangerouslySetInnerHTML={{ __html: error?.code === undefined ? t(description, { url: t('CONTACT_HELP_URL') }) : t('UNEXPECTED_POSTERROR', { error_message: error?.code ? t(error?.code) : error?.error }) }}
        />
        <Box mt={3} mb={1}>
