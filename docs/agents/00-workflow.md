...
- Despres d'escriure o editar codi, passa format sobre els fitxers tocats amb `npm run format -- <ruta-del-fitxer>` abans d'acabar.
...
3. `npm run format -- <ruta-del-fitxer>` sobre cada fitxer de codi editat.
