...
| Família grossa: `campaign-offer` | campanya 15 anys | entra com a cas patrocinat, preomple soci i força una entrada especial |
...
| És campanya | es comporta com patrocinat però amb soci preinjectat (`campaign-offer`) |
...
- [ ] Si hi ha campanya, has revisat `customInitialValues`, `campaign-offer` i els flags d'entorn.
